...
public class Ship implements MouseListener, MouseMotionListener{
	...
	public void mouseClicked(MouseEvent e) {
		//System.out.println("Mouse got clicked");
	...
	public void mousePressed(MouseEvent e) {
		//System.out.println("Mouse got Pressed");
		int mX = e.getX();
		int mY = e.getY();
		//System.out.println(mX +"," +mY);
		if(mX>= x - bottomWidth/2 && mX<= x+bottomWidth/2 &&
				mY >= y+2*eachHeight&& mY <= y+3*eachHeight) {
			shootTorpedo();
		}
	...
	public void mouseReleased(MouseEvent e) {
		//System.out.println("Mouse got Released");
	...
	public void mouseEntered(MouseEvent e) {
		//System.out.println("Mouse got entered");
	...
	public void mouseExited(MouseEvent e) {
		//System.out.println("Mouse got exited");
